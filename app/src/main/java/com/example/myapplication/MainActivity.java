...
//            ArrayAdapter<feedentry> arrayAdapter=new ArrayAdapter<feedentry>(MainActivity.this,R.layout.list_item,parseApplicaions.getApplications());
//            listView.setAdapter(arrayAdapter);
            FeedAdapter feedAdapter=new FeedAdapter(MainActivity.this,R.layout.list_record,parseApplicaions.getApplications());
